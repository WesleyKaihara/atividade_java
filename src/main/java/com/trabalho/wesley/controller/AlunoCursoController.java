...
public class AlunoCursoController {
    ...
    @PostMapping
    public ResponseEntity<AlunoCurso> cadastrarAluno(@RequestBody AlunoCurso alunoCurso) {
        return ResponseEntity.status(HttpStatus.CREATED).body(alunoCursoService.salvar(alunoCurso));
    }
}
